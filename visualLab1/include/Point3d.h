...
public:
 ...
 Point3d	operator-(const Point3d &p) const { return Point3d(x-p.x, y-p.y, z-p.z); }//����Ϊ��������أ�ʵ������֮�������
...
void		interpolate(const Point3d& a, const Point3d& b,float t)
 ...
 float		distPlane(const Point3d &normal, const Point3d &ppoint)//�㵽ƽ�����
 {
   return (x-ppoint.x)*normal.x + (y-ppoint.y)*normal.y + (z-ppoint.z)*normal.z;
 }


 void setPerp(const Point3d &vec) //����һ����ֱ��vec��ʸ������ʸ����ԭ��ָ�򱾵�
 {
